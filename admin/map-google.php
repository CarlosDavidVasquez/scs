  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="map-google.php" class="nav-link active">Google Maps</a></li>
    ...
    <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <a class="breadcrumb-item" href="index.php">Maps</a>
    ...
    <script src="../js/map.bluewater.js"></script>
    <script src="../js/map.shadesofgray.js"></script>
    <script src="../js/map.apple.js"></script>
