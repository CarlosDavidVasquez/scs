  ...
  <body>
    ...
    <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <a class="breadcrumb-item" href="index.php">Charts</a>
        <span class="breadcrumb-item active">Sparkline Charts</span>
      </nav>
      ...
      <div class="sl-pagebody">
        ...
        <pre><code class="javascript pd-20">$('#sparkline1').sparkline('html', {
  width: '100%',
  height: 70,
  lineColor: '#0083CD',
  fillColor: false
        ...
        <pre><code class="javascript pd-20">lineColor: '#0083CD',
fillColor: 'rgba(0,131,205,0.2)'</code></pre>
  ...
  sliceColors: ['#F4C62B', '#F6931E', '#8CC63E']
    ...
    <script src="../js/chart.sparkline.js"></script>
  </body>
</html>
